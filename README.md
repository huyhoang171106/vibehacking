...
[![Tools](https://img.shields.io/badge/Security%20Tools-156%2B-brightgreen.svg)](https://github.com/0x4m4/hexstrike-ai)
...
**Advanced AI-powered penetration testing MCP framework with 156+ security tools and 12+ autonomous AI agents**
...
<details>
<summary><b>🎯 CTF Solver Tools - Modular Challenge Automation (12 Tools - NEW in v6.0)</b></summary>

**Challenge Classification:**
- **ctf_classify_challenge** - Automatic CTF challenge detection and tool recommendation

**RSA Cryptography Attacks (3 Tools):**
- **ctf_rsa_auto_attack** - Automatic RSA attack selection (Wiener, Fermat, FactorDB)
- **ctf_rsa_wiener_attack** - Wiener's attack for large e and small d
- **ctf_rsa_fermat_attack** - Fermat factorization for close primes

**Format String & Binary Exploitation (4 Tools):**
- **ctf_format_string_arbitrary_write** - Generate format string arbitrary write payloads
- **ctf_format_string_got_overwrite** - Generate GOT overwrite payloads
- **ctf_rop_find_gadgets** - Extract ROP gadgets from binaries
- **ctf_rop_build_execve_chain** - Build ROP chains for execve('/bin/sh')

**Web Exploitation (4 Tools):**
- **ctf_web_ssrf_discover** - Discover SSRF vulnerability chains
- **ctf_web_race_condition** - Exploit race condition vulnerabilities
- **ctf_web_prototype_pollution** - Scan for prototype pollution vulnerabilities
- **ctf_web_jwt_attack** - JWT token analysis and attack automation

**Features:**
- Automated challenge classification and analysis
- Multi-technique RSA attack suite with auto-selection
- Format string payload generation for arbitrary memory writes
- ROP gadget extraction and chain building
- Web vulnerability discovery and exploitation
- Complete end-to-end CTF workflow automation

**Documentation:**
- See `docs/mcp-tools-guide.md` for detailed API documentation
- See `docs/ctf-workflows.md` for complete workflow examples
